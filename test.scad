...
//difference() {
//    
//    translate([0, 0, (insert_height + lip_height) / 2])  cube([lip_outer_distance, lip_outer_distance, insert_height - lip_height]);
//    }    
////    color("Blue") translate([0, 0 - powerstrip_width - 2, insert_height / 2]) cube([powerstrip_length + 1, powerstrip_width + 2, insert_height], center=true);
//}
